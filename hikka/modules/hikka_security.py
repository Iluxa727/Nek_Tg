...
class HikkaSecurityMod(loader.Module):
    ...
    strings_ru = {
        "no_command": (
            ...
            " </b><code>{}</code><b> не знайдена!</b>"
        ),
        "permissions": (
            "🔐 <b>Тут можна настроїти права для команди </b><code>{}{}</code>"
        ),
        "close_menu": "🙈 Закрити це меню",
        "global": (
            "🔐 <b>Тут можна настроїти глобальну виключену маску. Якщо тумблер"
            " виключений тут, він виключений для всіх команд</b>"
        ),
        "owner": "😎 Власник",
        "sudo": "🧐 Sudo",
        "support": "🤓 Помічник",
        "group_owner": "🧛‍♂️ Влас. группи",
        "group_admin_add_admins": "🧑‍⚖️ Адмін (добавляти учасників)",
        "group_admin_change_info": "🧑‍⚖️ Адмін (змінює інфо)",
        "group_admin_ban_users": "🧑‍⚖️ Адмін (банить)",
        "group_admin_delete_messages": "🧑‍⚖️ Адмін (удалять сообщения)",
        "group_admin_pin_messages": "🧑‍⚖️ Админ (закріплює)",
        "group_admin_invite_users": "🧑‍⚖️ Адмін (запрошувати)",
        "group_admin": "🧑‍⚖️ Адмін (любий)",
        "group_member": "👥 В группі",
        "pm": "🤙 В пп",
        "owner_list": (
            "<emoji document_id=5386399931378440814>😎</emoji> <b>Учасники группи"
            " </b><code>owner</code><b>:</b>\n\n{}"
        ),
        "sudo_list": (
            "<emoji document_id=5418133868475587618>🧐</emoji> <b>Учасники группи"
            " </b><code>sudo</code><b>:</b>\n\n{}"
        ),
        "support_list": (
            "<emoji document_id=5415729507128580146>🤓</emoji> <b>Учасники группи"
            " </b><code>support</code><b>:</b>\n\n{}"
        ),
        "no_owner": (
            "<emoji document_id=5386399931378440814>😎</emoji> <b>Немає учасників в"
            " группі </b><code>owner</code>"
        ),
        "no_sudo": (
            "<emoji document_id=5418133868475587618>🧐</emoji> <b>Немає учасників в"
            " группі </b><code>sudo</code>"
        ),
        "no_support": (
            "<emoji document_id=5415729507128580146>🤓</emoji> <b>Немає учасників в"
            " группі </b><code>support</code>"
        ),
        "no_user": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Вкажи, кому видати"
            " права</b>"
        ),
        "not_a_user": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Вказанна ціль - не"
            " учасник</b>"
        ),
        "cancel": "🚫 Відмінна",
        "confirm": "👑 Підтвердити",
        "self": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Неможна управляти"
            " своїми правами!</b>"
        ),
        "warning": (
            '⚠️ <b>Ти дійсно хочеш добавити <a href="tg://user?id={}">{}</a> в'
            " группу </b><code>{}</code><b>!\nЦя  дія може передати частинний або"
            " повний доступ до твого юзербота цьому учаснику!</b>"
        ),
        "suggest_nonick": (
            "🔰 <i>Чи хочеш ти включити NoNick для цього учасника?</i>"
        ),
        "user_nn": '🔰 <b>NoNick для <a href="tg://user?id={}">{}</a> виключений</b>',
        "enable_nonick_btn": "🔰 Включити",
        "owner_added": (
            '<emoji document_id="5386399931378440814">😎</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> доданий в группу </b><code>owner</code>'
        ),
        "sudo_added": (
            '<emoji document_id="5418133868475587618">🧐</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> доданий в группу </b><code>sudo</code>'
        ),
        "support_added": (
            '<emoji document_id="5415729507128580146">🤓</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> доданий в группу </b><code>support</code>'
        ),
        "owner_removed": (
            '<emoji document_id="5386399931378440814">😎</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> видалений з групи </b><code>owner</code>'
        ),
        "sudo_removed": (
            '<emoji document_id="5418133868475587618">🧐</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> видалений з групи </b><code>sudo</code>'
        ),
        "support_removed": (
            '<emoji document_id="5415729507128580146">🤓</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> видалений з групи </b><code>support</code>'
        ),
        "_cls_doc": "Управління настройками безпеки",
        "what": (
        ...
        "no_target": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Не вказана ціль"
            " правила безпеки</b>"
        ),
        "no_rule": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Не вказано правило"
            " безпеки (модуль або команда)</b>"
        ),
        "confirm_rule": (
            "🔐 <b>Будь ласка, подтвердіть що хочете видати  {} <a href='{}'>{}</a>"
            " право виконувати {} </b><code>{}</code><b> {}</b>"
        ),
        "multiple_rules": (
            "🔐 <b>Не получилось однозначно розпізнати правила безпеки. Виберіть"
            " те, яке мали :</b>\n\n{}"
        ),
        "rule_added": (
            "🔐 <b>Ви видали {} <a href='{}'>{}</a> право"
            " виконувати {} </b><code>{}</code><b> {}</b>"
        ),
        "rules": (
            "<emoji document_id=5472308992514464048>🔐</emoji> <b>Таргетування"
            " правила безпеки:</b>\n\n{}"
        ),
        "no_rules": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Немає таргетированних"
            " правил безпеки</b>"
        ),
        "owner_target": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Цей учасник -"
            " власник, його права не можуть управляти таргетированною"
            " безпекою</b>"
        ),
        "rules_removed": (
            "<emoji document_id=5472308992514464048>🔐</emoji> <b>Правила"
            ' таргетированної безпеки для <a href="{}">{}</a> удалени</b>'
        ),
        **service_strings_ru,
    }
