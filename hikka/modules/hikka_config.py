...
class HikkaConfigMod(loader.Module):
    ...
    strings_ru = {
        "choose_core": "🎚 <b>Виберіть категорію</b>",
        ...
        "configuring_option": (
            "🎚 <b>Управління параметром </b><code>{}</code><b> модуля"
            " </b><code>{}</code>\n<i>ℹ️ {}</i>\n\n<b>Стандарте:"
            " {}</b>\n\n<b>Текущее: {}</b>\n\n{}"
        ),
        "configuring_option_lib": (
            "🪴 <b>Управління параметром </b><code>{}</code><b> бібліотеки"
            " </b><code>{}</code>\n<i>ℹ️ {}</i>\n\n<b>Стандартне:"
            " {}</b>\n\n<b>Текущее: {}</b>\n\n{}"
        ),
        "option_saved": (
        ...
        "option_reset": (
            ...
            " скинутий до значення до простого</b>\n<b>Текущее: {}</b>"
        ),
        "option_reset_lib": (
            "♻️ <b>Параметр </b><code>{}</code><b> бібліотеки </b><code>{}</code><b>"
            " скинутий до значения до простого</b>\n<b>Текущее: {}</b>"
        ),
        "_cls_doc": "Інтерактивний конфігуратор Mikoss",
