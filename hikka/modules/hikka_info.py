...
class HikkaInfoMod(loader.Module):
    ...
    strings_ru = {
        ...
        "uptime": "Час роботи",
        "branch": "Гілка",
        "send_info": "Відправити інформацію про юзербота",
        "description": "ℹ Це не відкриє ніякої приватної інформації",
        "_ihandle_doc_info": "Відправити інформацію про юзербота",
        "up-to-date": (
            "<emoji document_id=5370699111492229743>😌</emoji><b> Актуальна версія</b>"
        ),
        "update_required": (
            "<emoji document_id=5424728541650494040>😕</emoji><b> Потрібно оновлення"
            " </b><code>.update</code>"
        ),
        "_cfg_cst_msg": (
            "Свій  текст повідомлення в info. Може мати ключові слова {me},"
            " {version}, {build}, {prefix}, {platform}, {upd}, {uptime}, {branch}"
        ),
        "_cfg_cst_btn": (
            "Своя  кнопка в повідомленні в info. залиш пустим, щоб  прибрати кнопку"
        ),
        ...
        "desc": (
            "<emoji document_id=6318565919471699564>🌌</emoji>"
            " <b>Mikoss</b>\n\nTelegram юзербот з великими  функціоналом, із"
            " яких: інлайн галерея, форми, списки, а також підтримка"
            " анімованих емодзиі. Юзербот - программа, чка запускається на"
            " твоєму Telegram-аккаунті. Коли ти пишеш команду в любому чаті, вона"
            " відразу ж виконується. подивись  на живі приклади на <a"
            ' href="https://github.com/hikariatama/Hikka">GitHub</a>'
        ),
    }
