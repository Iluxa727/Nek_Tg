...
class Translations(loader.Module):
    ...
    strings_ua = {
        ...
        "pack_saved": (
            "<emoji document_id=5368324170671202286>👍</emoji> <b>Пакет переводів"
            " Збережено!</b>"
        ),
        "incorrect_language": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Вказаний неправильна"
            " мова</b>"
        ),
        "lang_removed": (
            "<emoji document_id=5368324170671202286>👍</emoji> <b>Переводи скинуті"
            " на простий</b>"
        ),
        "check_pack": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Невірний формат"
            " пакета переводовів за посиланням</b>"
        ),
        "check_url": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Ви маєте вказати "
            " посилання, повний пакет переводів</b>"
        ),
        "too_long": (
            "<emoji document_id=5433653135799228968>📁</emoji> <b>Виведення команди дуже довге"
            " довгий, тому він буде відправлений в файлі.</b>"
        ),
        "opening_form": " <b>Відкриваю форму...</b>",
        "opening_gallery": " <b>Відкриваю галерею...</b>",
        "opening_list": " <b>Відкриваю список...</b>",
        "inline403": "🚫 <b>Ви не можете відправляти встроєні елементи в цьому чаті</b>",
        "invoke_failed": "<b>🚫 Виклик модуля не вдався! Більше інформації в логах</b>",
        "show_inline_cmds": "📄 Показати всі доступні встроєні команди",
        "no_inline_cmds": "У вас немає доступних inline команд",
        "no_inline_cmds_msg": (
            "<b>😔 Немає доступних inline команд або у вас нема доступа до них</b>"
        ),
        "inline_cmds": "ℹ️ У вас {} доступні(-их) команда(-и)",
        "inline_cmds_msg": "<b>ℹ️ Доступні inline команди:</b>\n\n{}",
        "run_command": "🏌️ Виконати команду",
        "command_msg": "<b>🌘 Команда «{}»</b>\n\n<i>{}</i>",
        "command": "🌘 Команда «{}»",
        "button403": "Ви не можете нажати на цю кнопку!",
