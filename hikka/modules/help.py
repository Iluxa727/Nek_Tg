...
class HelpMod(loader.Module):
    ...
    strings_ru = {
        ...
        "first_cmd_tmpl": ": ( {}",
        "cmd_tmpl": " | {}",
        "no_mod": "🚫 <b>Вкажи  модуль(-і), які потрібно сховати</b>",
        "hidden_shown": (
            "<emoji document_id=5188377234380954537>🌘</emoji> <b>{} модулів сховано,"
            " {} модулів показано:</b>\n{}\n{}"
        ),
        "ihandler": "\n🎹 <code>{}</code> {}",
        "undoc_ihandler": "🦥 Немає опису",
        "support": (
            "{} <b>Посилання на </b><a href='https://t.me/hikka_talks'>чат допомоги</a></b>"
        ),
        "_cls_doc": "Показує допомогу по модулям",
        "partial_load": (
            "<emoji document_id=5472105307985419058>☝️</emoji> <b>Юзербот ще не"
            " загрузився повністю, тому показані не всі модулі</b>"
        ),
        "not_exact": (
            "<emoji document_id=5472105307985419058>☝️</emoji> <b>Точного співпадіння"
            " не найшлось, тому був вибраний найбільш похожий</b>"
        ),
        "request_join": "Ви просили посилання на чат допомоги Mikoss",
        "core_notice": (
            "<emoji document_id=5472105307985419058>☝️</emoji> <b>Це  вбудований"
            " модуль. Ви не можете його вигрузити або  замінити</b>"
        ),
    }
