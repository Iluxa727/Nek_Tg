...
class InlineStuffMod(loader.Module):
    ...
    strings_ru = {
        "bot_username_invalid": (
            ...
            " бота. Віе має закінчуватися на </b><code>bot</code><b> и бути не менше"
            " ніж 5 символів</b>"
        ),
        "bot_username_occupied": (
        ...
        "bot_updated": (
            "<emoji document_id=6318792204118656433>🎉</emoji> <b>Налаштування збереженні."
            " Для їх застосування треба перезавантажити юзербот</b>"
        ),
        "this_is_hikka": (
            "🌘 <b>Привіт! Это Mikoss — сильний модульний Telegram юзербот. Ви можете"
            " встановити його на свій аккаунт!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikka_talks">Чат підтримки</a></b>'
        ),
    }
