...
class QuickstartMod(loader.Module):
    ...
    strings = {
        "name": "Quickstart",
        "base": """🌘🇺🇦 <b>Привіт.</b> Ви встановили юзер бота <b>Gikka</b> userbot.

❓ <b>потрібна допомога?</b> Можете безкоштовно  зайти до чату підтримки. We help <b>everyone</b>.

📼 <b>Ти можеш знайти  та встановити модулі через @hikkamods_bot. Simply enter your search query and click ⛩ Install on needed module</b>
