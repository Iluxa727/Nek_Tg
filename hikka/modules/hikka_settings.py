...
class HikkaSettingsMod(loader.Module):
    ...
    strings_ru = {
        ...
        "mod404": (
            "<emoji document_id=5447207618793708263>🚫</emoji> <b>Дивитель {} не"
            " знайдено</b>"
        ),
        "disabled": (
            "<emoji document_id=5424885441100782420>👀</emoji> <b>Дивитель {} тепер"
            " <u>виключений</u></b>"
        ),
        "enabled": (
        ...
        "deauth_confirm": (
            "⚠️ <b>Це  дійсно повністю видалить Mikoss с цього аккаунта! Йго не можна"
            " Відмінити</b>\n\n<i>- Всі чати, пов'язані з Mikoss будут видаленні\n- Сессія"
            " Mikos буде скинута\n- Інлайн бот Mikoss буде видалений</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ти точно упевнений, що хочеш видалити Mikoss?</b>",
        "deauth_yes": "Так,Я дебіл",
        "deauth_no_1": "Я не впевнений",
        "deauth_no_2": "Не точно",
        "deauth_no_3": "Ні",
        "deauth_cancel": "🚫 Відмінна",
        "deauth_confirm_btn": "😢 Видалити",
        "uninstall": "😢 <b>Видаляю Mikoss...</b>",
        "uninstalled": (
            "😢 <b>Mikoss видалений. Веб-інтерфейс все ще активний, можно додати інші "
            " аккаунти!</b>"
        ),
        "logs_cleared": "🗑 <b>Логи почищені</b>",
        "cmd_nn_list": (
            "<emoji document_id=5469791106591890404>🪄</emoji> <b>NoNick включений для"
            " цих команд:</b>\n\n{}"
        ),
        "user_nn_list": (
            "<emoji document_id=5469791106591890404>🪄</emoji> <b>NoNick включений для"
        ...
        "nothing": (
            "<emoji document_id=5427052514094619126>🤷‍♀️</emoji> <b>Нічого"
            " показувати...</b>"
        ),
        "privacy_leak": (
            "⚠️ <b>Ця команда дає доступ до веб-інтерфейсу Mikoss. її виконання в"
            " публічних чатах являється загрозою безпеки. Краще  виконати "
            " її в <a href='tg://openmessage?user_id={}'>в збережених повідомленнях</a>."
            " Виповни </b><code>{}proxypass force_insecure</code><b> щоби відключити"
            " це попередження</b>"
        ),
        "privacy_leak_nowarn": (
            "⚠️ <b>Ця команда дає доступ до веб-інтерфейсу Mikoss. її виконання в"
            " публічних чатах являється загрозую безпеки. Краще виконувати"
            " її в <a href='tg://openmessage?user_id={}'>Збережених повідомленнях</a>.</b>"
        ),
        "opening_tunnel": "🔁 <b>Відкриваю  туннель кдо веб-інтерфейсу Mikoss...</b>",
        "tunnel_opened": (
            "🎉 <b>Туннель відкритий. Це посилання буде активне не більше години</b>"
        ),
        "web_btn": "🌍 Веб-інтерфейс",
        "btn_yes": "🚸 Все одно відкрити",
        "btn_no": "🔻 Закрити",
        "lavhost_web": (
            "✌️ <b>По цьому посиланні ти попадеш до веб-інтерфейс Mikoss на"
            " lavHost</b>\n\n<i>💡 Тебі потрібно буде авторизоватися, за  данними,"
            " вказаними при налаштувані lavHost</i>"
        ),
        "disable_stats": "✅ Анонімна стата дозволена",
        "enable_stats": "🚫 Анонімна стата не дозволена",
    }
