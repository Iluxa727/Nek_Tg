...
class HikkaBackupMod(loader.Module):
    ...
    strings_ru = {
        "period": (
            "⌚️ <b>Юнит «ALPHA»</b> створуює щоденні резервні копії. ці налаштування"
            " можна буде змінити потім.\n\nПожалуйста, виберіть період  резервного"
            " копіювання"
        ),
        "saved": (
            "✅ Періодичність збережена! її можна змінити командою .set_backup_period"
        ),
        "never": (
            "✅ Я не буду роботи автоматичне резервне копіювання. Можно відмінити"
            " Використавши .set_backup_period"
        ),
        "invalid_args": (
            "🚫 <b>Вкажи правильний період  в годинах, або `0` для відключення</b>"
        ),
    }
