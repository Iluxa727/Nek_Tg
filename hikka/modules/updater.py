...
class UpdaterMod(loader.Module):
    ...
    strings_ru = {
        ...
        "downloading": (
            "<emoji document_id=6318970114548958978>🕗</emoji> <b>Скачивання"
            " оновлення...</b>"
        ),
        "installing": (
        ...
        "success": (
            ...
            " успешне! {}</b>\n<i>Но модули ще загружаються...</i>\n<i>Перезавантаження"
            " зайняло {} сек</i>"
        ),
        "full_success": (
            "<emoji document_id=6323332130579416910>👍</emoji> <b>Юзербот повністю"
            " завантажений! {}</b>\n<i>Повна перезагрузка зайняла {} сек</i>"
        ),
        "secure_boot_complete": (
        ...
        "restart_confirm": "❓ <b>Ти впевнений, що хочеш перезавантажетись?</b>",
        "secure_boot_confirm": (
            "❓ <b>Ты уверен, что"
        ...
        "no_update": "🚸 <b>У тебе остання  версія. Оновитися?</b>",
        "cancel": "🚫 Відмовитись",
        "_cls_doc": "оновляє юзербот",
        "lavhost_restart": (
            "<emoji document_id=5469986291380657759>✌️</emoji> <b>Твій {}"
            " перезавантажить ся...</b>"
        ),
        "lavhost_update": (
